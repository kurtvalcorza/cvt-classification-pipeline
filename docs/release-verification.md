...
The upstream snapshot is pinned to `84e365a5f6a5ca987486abb25f3d8e5265cdc44d` and the notebook is regenerated with that revision and manifest, so it can run; no execution is recorded yet.
